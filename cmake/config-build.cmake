...
option(RTS_BUILD_OPTION_PROFILE_TRACY "Build code with Tracy profiling enabled." ON)
...
if(RTS_BUILD_OPTION_DEBUG)
    target_compile_definitions(core_config INTERFACE RTS_DEBUG DEBUG DEBUG_LOGGING=1)
else()
    target_compile_definitions(core_config INTERFACE RTS_RELEASE NDEBUG)
endif()

if(RTS_BUILD_OPTION_PROFILE)
    target_compile_definitions(core_config INTERFACE RTS_PROFILE_TRACY)
endif()
...
if(RTS_BUILD_OPTION_PROFILE_TRACY)
    ...
    add_library(tracy_runtime INTERFACE)
endif()
