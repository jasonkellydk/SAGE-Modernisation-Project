...
{
	assert((set_box != nullptr));
	assert(((i >= 0) && (j >= 0) && (k >= 0)));
	assert(((i < CellCount[0]) && (j < CellCount[1]) && (k < CellCount[2])));
...
{
	assert((set_box != nullptr));
	assert(((vol.Min[0] >= 0) && (vol.Min[1] >= 0) && (vol.Min[2] >= 0)));
	assert(((vol.Max[0] <= CellCount[0]) && (vol.Max[1] <= CellCount[1]) && (vol.Max[2] <= CellCount[2])));
