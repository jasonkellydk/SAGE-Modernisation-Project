...
enum
{
	...
	CHUNKID_CURVES_BEGIN				= 0x00080000,
	CHUNKID_WWTRANSLATEDB_BEGIN		= 0x00090000
};

enum
{
	CHUNKID_LINEAR_CURVE_1D = CHUNKID_CURVES_BEGIN,
	CHUNKID_HERMITE_SPLINE_1D,
	CHUNKID_CATMULL_ROM_SPLINE_1D,
	CHUNKID_CARDINAL_SPLINE_1D,
	CHUNKID_TCB_SPLINE_1D,

	CHUNKID_LINEAR_CURVE_3D = CHUNKID_CURVES_BEGIN + 0x100,
	CHUNKID_HERMITE_SPLINE_3D,
	CHUNKID_CATMULL_ROM_SPLINE_3D,
	CHUNKID_CARDINAL_SPLINE_3D,
	CHUNKID_TCB_SPLINE_3D,
	CHUNKID_VEHICLE_CURVE
};
